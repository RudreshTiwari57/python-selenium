#the opening of the browser is by creating object of of the chrome ,firefox,IE ect
#sometimes you have to provide the path of the browser to the class while creating the object
import time
